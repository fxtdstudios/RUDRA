...
| Video decode, encode | Phase 4 (section 17): steps 1 and 2 of 12 done: the probe, clock and input contract equal to `rudra/video.py` on 23 cases (`media/video_probe`, `platform/process`), and the decoder's command and frames equal to the Python's (`media/video_decode`) |
