...
Train the SDR to HDR model. Four stages. Each one checks its own output and
refuses to hand work to the next stage if the check fails.
...
Then train the shadow gate on the frozen result. Fifteen minutes on one 4080.
